...
public class TestCasePrinter {
	...
	public void testPrintPositiveMatchingResults() {
		...
		assertNotNull(printer.printPositiveMatchingResults(resultsCheckedAtt));
	...
	assertNotNull( printer.printPositiveMatchingResults(null));
	...
	assertTrue (printer.printPositiveMatchingResults(resultsCheckedAtt).size() ==2 );
...
*/
	...
	public void testPrintNegativeMatchingResults() {
		...
		//testing NullPointerException
		assertNotNull(printer.printNegativeMatchingResults(resultsCheckedAtt));
	...
	assertNotNull( printer.printNegativeMatchingResults(resultsCheckedAtt));
		...
		//testing NullPointerException through Return-Object-Type	
	assertNotNull( printer.printNegativeMatchingResults(null));
	...
	assertNotNull( printer.printNegativeMatchingResults(resultsCheckedAtt));
		...
		//testing if numbers of input is equal to numbers of output
		//input = 2 Artifacte, expected output is 2
	assertTrue (printer.printNegativeMatchingResults(resultsCheckedAtt).size() ==2 );
